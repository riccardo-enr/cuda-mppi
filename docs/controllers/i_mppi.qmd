...
![I-MPPI Exploration Campaign. The heatmap shows the Informative Cost (lower is better, corresponding to high Information Gain). The Informative MPPI (red) proactively explores the unknown area behind the wall, while the Standard MPPI (white) simply follows the corridor.](../_media/imppi_campaign.png)

### Performance Comparison

| Metric | Standard MPPI | Informative MPPI |
|--------|---------------|------------------|
| Information Gain (nats) | Low | **High** |
| Average Velocity | Constrained | **Agile** |
| CUDA Latency (512 samples) | ~2ms | ~5ms |
