...
![I-MPPI Exploration Campaign. The heatmap (Plasma) shows the Information Gain field. Cyan lines indicate the true wall locations. The Standard MPPI (black dashed) takes the direct route, while the Informative MPPI (white solid) seeks out informative viewpoints in the unknown blobs at the top-left and bottom-right.](../_media/imppi_campaign.png)
