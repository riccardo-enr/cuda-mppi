...
cfg.set_control_sigma([2.0, 0.5, 0.5, 0.3])  # per-channel noise std
cfg.num_support_pts = 10    # K-MPPI: number of RBF support points
cfg.w_action_seq_cost = 1.0 # S-MPPI: smoothness cost weight
```
...
| Method | Description |
|--------|-------------|
| `compute(state)` | Run $K$ GPU rollouts and compute optimal action |
