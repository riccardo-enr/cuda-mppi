...
> **Known issue:** Effective exploration collapses to near-zero for small
> $\Delta t$ because `integrate_actions_kernel` scales noise by $\Delta t$.
> Tracking diverges until [issue #30](https://github.com/riccardo-enr/cuda-mppi/issues/30) is fixed.
